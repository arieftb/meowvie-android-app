...
import id.my.arieftb.core.domain.usecase.contents.SearchContentsUseCaseImpl
import id.my.arieftb.core.domain.usecase.date.*
import id.my.arieftb.core.domain.usecase.language.GetLanguageUseCase
import id.my.arieftb.core.domain.usecase.language.GetLanguageUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.GetMoviesUseCase
import id.my.arieftb.core.domain.usecase.movies.GetMoviesUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.detail.GetMovieDetailUseCase
import id.my.arieftb.core.domain.usecase.movies.detail.GetMovieDetailUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.highlight.GetMoviesHighlightUseCase
import id.my.arieftb.core.domain.usecase.movies.highlight.GetMoviesHighlightUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.popular.GetMoviesPopularHighlightUseCase
import id.my.arieftb.core.domain.usecase.movies.popular.GetMoviesPopularHighlightUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.popular.GetMoviesPopularUseCase
import id.my.arieftb.core.domain.usecase.movies.popular.GetMoviesPopularUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.upcoming.GetMoviesUpcomingHighlightUseCase
import id.my.arieftb.core.domain.usecase.movies.upcoming.GetMoviesUpcomingHighlightUseCaseImpl
import id.my.arieftb.core.domain.usecase.movies.upcoming.GetMoviesUpcomingUseCase
import id.my.arieftb.core.domain.usecase.movies.upcoming.GetMoviesUpcomingUseCaseImpl
import id.my.arieftb.core.domain.usecase.tv_shows.GetTvShowsUseCase
import id.my.arieftb.core.domain.usecase.tv_shows.GetTvShowsUseCaseImpl
import id.my.arieftb.core.domain.usecase.tv_shows.detail.GetTvShowDetailUseCase
import id.my.arieftb.core.domain.usecase.tv_shows.detail.GetTvShowDetailUseCaseImpl
import id.my.arieftb.core.domain.usecase.tv_shows.highlight.GetTvShowsHighlightUseCase
import id.my.arieftb.core.domain.usecase.tv_shows.highlight.GetTvShowsHighlightUseCaseImpl
import id.my.arieftb.core.domain.usecase.tv_shows.popular.GetTvShowsPopularHighlightUseCase
import id.my.arieftb.core.domain.usecase.tv_shows.popular.GetTvShowsPopularHighlightUseCaseImpl
import id.my.arieftb.core.domain.usecase.tv_shows.popular.GetTvShowsPopularUseCase
import id.my.arieftb.core.domain.usecase.tv_shows.popular.GetTvShowsPopularUseCaseImpl
import id.my.arieftb.core.domain.usecase.tv_shows.upcoming.GetTvShowsUpcomingHighlightImpl
...
import id.my.arieftb.core.domain.usecase.tv_shows.upcoming.GetTvShowsUpcomingUseCaseImpl
import id.my.arieftb.core.domain.usecase.watch_list.*
